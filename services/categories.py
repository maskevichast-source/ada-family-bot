...
# Лимиты по умолчанию (необходимы для модуля services/limits_ai.py)
...
# Универсальная матрица неоднозначных триггеров и кнопок
AMBIGUOUS_TRIGGERS: dict[str, list[dict]] = {
    # Еда: перекус вне дома vs продукты домой
    "сендвич": [
...
def is_ambiguous_item(text: str) -> tuple[bool, list[str]]:
    """Совместимость для vision.py и классификатора."""
