...
ВАЛЮТА:
- "currency" — валюта РОВНО как написана на чеке (например "USD", "RUB", "EUR"), не пересчитывай
  сама в тенге и не выдумывай курс. "amount" — сумма в этой валюте как есть на чеке. Конвертацию
  в KZT сделает код по официальному курсу.
"""
